      ...
      <div class="card stat-card">
        <div class="stat-top">
          <div class="stat-icon blue">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M9 8h1M14 8h1M9 12h1M14 12h1M9 16h1M14 16h1"/></svg>
          </div>
      ...
      <div class="card stat-card">
        <div class="stat-top">
          <div class="stat-icon yellow">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 6h16M4 6l1.5 13a2 2 0 0 0 2 1.8h9a2 2 0 0 0 2-1.8L20 6M9 6V4.5A1.5 1.5 0 0 1 10.5 3h3A1.5 1.5 0 0 1 15 4.5V6"/><circle cx="12" cy="12.5" r="2.3"/></svg>
          </div>
        ...
        <div class="announce-list">
          ...
          <div class="announce-item">
            ...
            <div class="announce-body">
              ...
              <p class="announce-desc">The prelim examination schedule for all INFT courses has been finalized. Please check your respective sections and reporting times.</p>
            </div>
          </div>
          ...
          <div class="announce-item">
            ...
            <div class="announce-body">
              ...
              <p class="announce-desc">Register your student organization for a booth at the annual Tech Fair happening on October 15 at the PCU Gymnasium.</p>
            </div>
          </div>
          ...
          <div class="announce-item">
            ...
            <div class="announce-body">
              ...
              <p class="announce-desc">The main library will have limited operations due to scheduled HVAC maintenance. Study areas on the 2nd floor remain open.</p>
            </div>
          </div>
      ...
      <div>
        ...
        <div class="quick-actions">
          <div class="qa-btn">
            <div class="qa-icon navy">
              <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.8"><rect x="3" y="4" width="18" height="17" rx="2"/><path d="M3 9h18M8 2v4M16 2v4"/></svg>
            </div>
            <div class="qa-label">Book Facility</div>
          </div>
          <div class="qa-btn">
            <div class="qa-icon amber">
              <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.8"><rect x="3" y="8" width="18" height="13" rx="1.5"/><path d="M3 8l2-4h14l2 4"/><path d="M9 12a3 3 0 0 0 6 0"/></svg>
            </div>
            <div class="qa-label">Report Item</div>
          </div>
          <div class="qa-btn full">
            <div class="qa-icon violet">
              <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.8"><path d="M18 9a6 6 0 0 0-12 0c0 5-2 6-2 6h16s-2-1-2-6Z"/><path d="M10.5 19a1.6 1.6 0 0 0 3 0"/></svg>
            </div>
        ...
        <div class="info-banner">
          <div class="info-banner-head">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 11v5.5M12 8v.01"/></svg>
            PCU INFO
          </div>
      ...
      <div class="card panel">
        ...
        <div class="list-row">
          <div class="row-icon pink">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="7"/><path d="M12 9v3l2 1.5"/><path d="M9 3h6M9 21h6"/></svg>
          </div>
          <div class="row-body">
        ...
        <div class="list-row">
          <div class="row-icon purple">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="9" cy="12" r="2.2"/><path d="M14 10h4M14 14h4"/></svg>
          </div>
          <div class="row-body">
        ...
        <div class="list-row">
          <div class="row-icon blue">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="4" y="4" width="16" height="11" rx="1.5"/><path d="M2 19h20l-1.5-3H3.5L2 19Z" stroke-linejoin="round"/></svg>
          </div>
          <div class="row-body">
